...
cluster = [ ClusterAnnotation("A1644", 2560 - 200, 1479 - 30),
            ...
            ClusterAnnotation("A1367", 2803 + 20, 1850),
            ...
            ClusterAnnotation("Coma", 2360, 1975),
            ...
            ClusterAnnotation("2A0335+096", 295+80, 444)   ]
...
filename = "CReP_seed"
im_cmap = cmr.freeze
cb_label = "CR Electron Energy Density  " * L"\epsilon_{\mathrm{CR,e} \in 5-500 \mathrm{ MeV}}" * " [erg cm" * L"^{-3}" * "]"
clim_arr = [1.e-21, 5.e-17]
plot_name = "Fig01a"
...
filename = "CReE"
im_cmap = cmr.cosmic
cb_label = "CR Electron Energy " * L"E_{\mathrm{CR},e > 1 \: \mathrm{GeV}}" * " [erg cm" * L"^{-2}" * "]"
clim_arr = [1.e1, 1.e5]
plot_name = "Fig01b"
